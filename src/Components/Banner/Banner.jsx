            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
                ...
                <div className='flex flex-cold gap-4'>
                    <div data-aos="fade-up" className='flex-items-center gap-4'>
                        <GrSecure
                            className="text-4xl h-12 w-12 shdow-sm p-4 rounded-full bg-violet-100 dark:bg-violet-400"/>
                        <p>Quality Products</p>
                    </div>
                    <div data-aos="fade-up" className='gap-4 '>
                        <IoFastFood className='text-4xl h-12 w-12 shadow-sm rounded-full bg-orange-100 dark:bg-orange-400'/>
                        <p>Fast Delivery</p>
                    </div>
                          <div data-aos="fade-up" className='gap-4 '>
                        <GiFoodTruck className='text-4xl h-12 w-12 shadow-sm rounded-full bg-orange-100 dark:bg-orange-400'/>
